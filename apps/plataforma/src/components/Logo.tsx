/**
 * Isotipo Valar. Copia literal del componente del sitio público
 * (apps/web/src/components/Logo.tsx): son los trazos del manual de marca, no
 * se rediseñan por app. Si cambian, se cambian en los dos lugares.
 */
